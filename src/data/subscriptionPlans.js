...
export const PLAN_ENTITLEMENTS = {
  ...
  basic: {
    ...
    professionalResources: false, liveClasses: true, prioritySupport: false,
    facultyBadge: false, earlyAccess: false,
  },
  pro: {
...
export const SUBSCRIPTION_PLANS = [
  ...
  },
  {
    ...
    duration_days: 30,
    question_limit: 2000,
    features: ['2,000+ questions', '50+ NGN case studies', 'Unlimited practice and timed modes', '5 CAT exams', '2 readiness assessments', 'All video lessons', 'High-yield notes and flashcards', 'NurseFaculty Tutor and rationale support', 'Subscriber live classes', 'CPD Centre and professional learning', 'Weak-area analysis', 'Study planner and daily goals'],
    is_active: true,
    sort_order: 2,
  },
  {
