...
export const nurseFacultyTables = {
  ...
  institutionAccounts: 'institution_accounts',
  institutionLicenseSeats: 'institution_license_seats',
  billingPaymentMethods: 'billing_payment_methods',
  billingTransactions: 'billing_transactions',
  billingSettings: 'billing_settings',
  instructorResources: 'instructor_resources',
