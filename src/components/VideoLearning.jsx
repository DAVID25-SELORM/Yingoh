...
const DEMO_VIDEOS = [
  ...
  { id: 'v3', title: 'CAT Strategy: How the NCLEX Adapts to You', description: 'How Computer Adaptive Testing works on the Next Generation NCLEX and strategies to approach hard questions with confidence.', topic: 'Test Strategy', video_url: 'https://www.youtube.com/embed/3TdnyZDG44Q', duration_mins: 20, is_published: true, is_premium: false, view_count: 2103, sort_order: 3 },
  { id: 'v4', title: 'Critical Lab Values You Must Know', description: 'Master the critical lab values most likely on NCLEX. Includes sodium, potassium, glucose, CBC, ABGs, and more.', topic: 'Medical-Surgical', video_url: 'https://www.youtube.com/embed/cnE5EvJ_mdY', duration_mins: 25, is_published: true, is_premium: true, view_count: 756, sort_order: 4 },
  { id: 'v5', title: 'Mental Health Nursing: Therapeutic Communication NCLEX Review', description: 'The ultimate NCLEX review for therapeutic communication techniques, do\'s and don\'ts, and mental health priority nursing interventions.', topic: 'Mental Health', video_url: 'https://www.youtube.com/embed/V1WbahXiFlw', duration_mins: 35, is_published: true, is_premium: false, view_count: 614, sort_order: 5 },
  { id: 'v6', title: 'Maternal-Newborn: Priority Nursing Actions', description: 'High-yield maternal and newborn content. Covers labor stages, postpartum complications, and newborn assessments for NCLEX.', topic: 'Maternal and Newborn', video_url: 'https://www.youtube.com/embed/r3W3wFR5ubM', duration_mins: 35, is_published: true, is_premium: true, view_count: 432, sort_order: 6 },
];
