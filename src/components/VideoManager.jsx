...
const DEMO_VIDEOS = [
  { id: 'v1', title: 'NCLEX Pharmacology: High-Yield Drug Classes', topic: 'Pharmacology', video_url: 'https://www.youtube.com/embed/dQw4w9WgXcQ', duration_mins: 45, is_published: true, is_premium: false, view_count: 1240, sort_order: 1, description: 'Cover the 20 most-tested drug classes.' },
  { id: 'v2', title: 'NGN Case Study Walkthrough', topic: 'NGN Case Studies', video_url: 'https://www.youtube.com/embed/dQw4w9WgXcQ', duration_mins: 38, is_published: true, is_premium: false, view_count: 987, sort_order: 2, description: 'Step-by-step NGN case study breakdown.' },
  { id: 'v3', title: 'CAT Strategy: How to Think Like a Nurse', topic: 'Test Strategy', video_url: 'https://www.youtube.com/embed/dQw4w9WgXcQ', duration_mins: 30, is_published: true, is_premium: false, view_count: 2103, sort_order: 3, description: 'CAT test strategies for NCLEX.' },
  { id: 'v4', title: 'Critical Lab Values You Must Know', topic: 'Medical-Surgical', video_url: 'https://www.youtube.com/embed/dQw4w9WgXcQ', duration_mins: 25, is_published: true, is_premium: true, view_count: 756, sort_order: 4, description: 'Critical lab values for NCLEX.' },
];
